...
plot(GRBI2$LONGITUDE, GRBI2$LATITUDE)
table(GRBI2$LATITUDE)
table(GRBI2$LONGITUDE)
GRBI=GRBI2
```
...
```{r}
waic <- sapply(mget(paste0("modelPPmany", 1:5)), function(x) x$waic$waic)
names(waic) <- paste0("model", 1:5)
waic
