...
```{r base fig.2, fig.align='center', out.width = "100%", fig.asp = .4, echo=FALSE, eval = TRUE}
#### Figure format ####
...
plot(n_QC$Time[n_QC$scenario=="Climate-only"], n_QC$n[n_QC$scenario=="Climate-only"], type = "b", col = "darkblue", ylim = c(1000, 7000),
    ylab = "Number of patches", xlab = "Time", cex.lab  = 1.5)
lines(n_QC$Time[n_QC$scenario=="Forest composition"], n_QC$n[n_QC$scenario=="Forest composition"], type = "b", col = "darkorange")
...
plot(area_QC$Time[area_QC$scenario=="Climate-only"], area_QC$area[area_QC$scenario=="Climate-only"], type = "b", col = "darkblue", ylab = "Median patch area (km2)", xlab = "Time", ylim = c(0.1,0.35), cex.lab  = 1.5)
lines(area_QC$Time[area_QC$scenario=="Forest composition"], area_QC$area[area_QC$scenario=="Forest composition"], type = "b", col = "darkorange")
...
plot(dist_QC$Time[dist_QC$scenario=="Climate-only"], dist_QC$dist[dist_QC$scenario=="Climate-only"], type = "b", col = "darkblue", ylab = "Median inter-patch distance (km)", xlab = "Time", ylim = c(215,280), cex.lab = 1.5)
lines(dist_QC$Time[dist_QC$scenario=="Forest composition"], dist_QC$dist[dist_QC$scenario=="Forest composition"], type = "b", col = "darkorange")
...
# Rescale capacity
capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1] <- log10(capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1]/capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1][1]) + 1

capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==0.002] <- log10(capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==0.002]/capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==0.002][1]) + 1

capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==1] <- log10(capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==1]/capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==1][1]) + 1

capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==0.002] <- log10(capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==0.002]/capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==0.002][1]) + 1
...
# Plot climate-only
plot(totalArea_QC$Time[totalArea_QC$scenario=="Climate-only"], totalArea_QC$totalArea[totalArea_QC$scenario=="Climate-only"], type = "b", col = "darkblue", ylab = "", xlab = "Time", cex.lab = 1.5, ylim = c(0,2))
lines(capacity_QC$Time[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1], capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1], type = "b", col = "lightgrey", lty = 2)
lines(capacity_QC$Time[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==0.002], capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==0.002], type = "b", col = "darkgrey", lty = 2)

plot(totalArea_QC$Time[totalArea_QC$scenario=="Forest composition"], totalArea_QC$totalArea[totalArea_QC$scenario=="Forest composition"], type = "b", col = "darkorange", ylab = "", xlab = "Time", cex.lab = 1.5, ylim = c(0,2))
lines(capacity_QC$Time[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==1], capacity_QC$capacity[capacity_QC$scenario=="Climate-only" & capacity_QC$alpha==1], type = "b", col = "lightgrey", lty = 2)
lines(capacity_QC$Time[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==0.002], capacity_QC$capacity[capacity_QC$scenario=="Forest composition" & capacity_QC$alpha==0.002], type = "b", col = "darkgrey", lty = 2)
