...
plot.capacity <- function(cc, totalArea, file.name, alpha = c(1, 5, 50, 200, 500)){
...
# 
p_capQC <- plot.capacity(cc, totalArea_QC, compute.cap = TRUE, file.name = "/Users/victorcameron/Documents/Git/Metapop_ms/SDM/results/capacities_QC.RDS")
p_capM <- plot.capacity(cc, totalArea_M, compute.cap = TRUE, file.name = "/Users/victorcameron/Documents/Git/Metapop_ms/SDM/results/capacities_M.RDS")
p_capET <- plot.capacity(cc, totalArea_ET, file.name = "/Users/victorcameron/Documents/Git/Metapop_ms/SDM/results/capacities_ET.RDS")
