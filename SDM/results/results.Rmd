...
ggplot(data=totalArea_QC, aes(x=temp, y=totalArea*400)) +
geom_line() +
geom_line(data=cap_QC, aes(y=capacity))

ggplot(data=totalArea_ET, aes(x=temp, y=totalArea)) +
geom_line() +
geom_line(data=cap_ET, aes(y=capacity*100))

ggplot(data=totalArea_M, aes(x=temp, y=totalArea)) +
geom_line() +
geom_line(data=cap_M, aes(y=capacity*2000))
```
...
par(mfrow = c(1,3))
barplot(t(t_GRBI_QC), beside = TRUE, legend = TRUE, main = "Québec")
