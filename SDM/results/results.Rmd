...
```{r 4 range map, fig.align='center', out.width = "100%", echo=FALSE}
plot.map3()
```
...
These confounding results are the result of the distribution expansion to previously unsuitable habitat (colonization) hiding the effects of patch contraction, extinction and fragmentation.
