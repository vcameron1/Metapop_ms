...
To protect ecosystems, we need to predict how communities will be affected to coordonate efficient conservation actions.
...
More flexible, but similar models have been proposed to study the role of spatial and biotic sources of compelxity in shaping species distributions (j-SDMs; Pollock et al. 2014, Warton 2015).
...
Our current lack of knowledge and tools for the prediction pf species distribution responses to environmental changes poses serious limitations on the efficiency of future conservation actions.
While most current predictive approaches ingnore important biological mechanisms, these mechanisms are known to play an important role in species distribution response to environmental change (Urban 2016).
